...
class QuizMandarin : AppCompatActivity() {
    ...
    private val questions = listOf(
        Question("What is the Mandarin term for 'Hello'?", "你好 (Nǐ hǎo)", "谢谢 (Xièxiè)", "你好 (Nǐ hǎo)"),
        Question("What is the Mandarin term for 'Thank you'?", "你好 (Nǐ hǎo)", "谢谢 (Xièxiè)", "谢谢 (Xièxiè)"),
        Question("What is the Mandarin term for 'Good morning'?", "早上好 (Zǎoshang hǎo)", "再见 (Zàijiàn)", "早上好 (Zǎoshang hǎo)"),
        Question("What is the Mandarin term for 'Goodbye'?", "早上好 (Zǎoshang hǎo)", "再见 (Zàijiàn)", "再见 (Zàijiàn)"),
        Question("What is the Mandarin term for 'Yes'?", "是的 (Shì de)", "不是 (Bù shì)", "是的 (Shì de)")
    )
